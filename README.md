# PROFILE
![150_170](https://github.com/user-attachments/assets/0ec91908-23c0-424d-bb22-8866b516a67d)
#### NAME: 권영하
#### BIRTH: 1989.11.02
...
## 경력 사항
|**회사명**|**재직기간**|**소속**|**직위/직책**|**직무**|
|:--------:|:--------:|:--------:|:--------:|:--------:|
| 코너스톤42| 2025.04 ~ 재직중  | DX Solutions | Professional/팀장 | Lead developer |
| CJ제일제당| 2021.09 ~ 2025.03  | 디지털혁신 | Professional(과장)/팀원 | 정보 전략(Data engineer) |
| 엑셈    | 2020.05 ~ 2021.09  | 신기술본부 AI그룹| 대리/파트장 | Data engineer |
| 세스코  | 2019.11 ~ 2020.04  | 마케팅실 | 사원 | ML engineer/팀원 |
| 인실리코 | 2017.04 ~ 2019.06 | 기획실 | 주임 연구원 | Data engineer/팀원 |

## 논문/특허
```
2024.01, 다중 도메인 데이터를 이용한 국내 돼지고기 가격 예측(Domestic pork price forecasting using multi-domain data)
2020.05, 인공지능을 활용한 소재 조성 추천 방법 및 이를 이용한 소재 조성 추천 장치
```
...
프로젝트 분야: Vision AI
고객사: CJ제일제당
개발기간: 2021.11 ~ 2022.03
구축환경(HW,OS,언어,DB 등): Linux, Python, Tensorflow
상세내용:
- SDK 개발, 환경 구성 및 시스템 구축
- 데이터 수집 및 적재
- 모델링 및 검증
...
구축환경(HW,OS,언어,DB 등): Linux, Python, Tensorflow, AWS Services
상세내용:
- 환경 구성 및 시스템 구축
- 데이터 수집 및 적재
- 데이터 검증
...
고객사: CJ제일제당
개발기간: 2021.11 ~ 2021.12
구축환경(HW,OS,언어,DB 등): Linux, Python, Tensorflow, Django, AWS Services
상세내용:
- 환경 구성 및 시스템 구축
- 데이터 수집 및 적재
- 데이터 검증
...
구축환경(HW,OS,언어,DB 등): Amazon Linux, Python, Tensorflow, Django, AWS Services
상세내용:
- 아키텍처 설계/기획
- 사업 관리
